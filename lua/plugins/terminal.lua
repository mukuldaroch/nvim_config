 ...
 config = function()
  ...
  local lazygit = Terminal:new({
   ...
   on_open = function(term)
    ...
    vim.api.nvim_buf_set_keymap(term.bufnr, "t", "<esc>", "<C-\\><C-n>:q<CR>", { noremap = true, silent = true })
   end,
  })
  ...
  vim.api.nvim_set_keymap("n", "<leader>t", ":lua toggle_general_terminal()<CR>", { noremap = true, silent = true })
